...
<dl>
	<dt>@machine</dt>
	<dd>names the machine, in this example the classes _TrafficLightMachine.m (implementation class) and TrafficLightMachine.m (user class) will represent the machine in source code.</dd>
	<dt>@initial</dt>
	<dd>defines the initial state of the machine, no enter event is generated by the machine being placed in this state.</dd>
	<dt>@state</dt>
	<dd>defines a named state.</dd>
	<dt>@enter</dt>
	<dd>specifies that a callback (e.g. enterGreenState) will be generated and invoked when the machine enters this state.</dd>
	<dt>@exit</dt>
	<dd>specifies than a callback (e.g. exitAmberState) will be generated and invoked before the machine leaves this state.</dd>
	<dt>@event</dt>
	<dd>defines an event that transitions the machine into a target state along with a method on the machine class (e.g. amberEvent) to cause the transition.</dd>
</dl>
